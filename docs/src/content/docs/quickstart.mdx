...
See [Built-in Providers](/configuration/built-in-providers) for all available providers and recommended models, and [Env Vars](/configuration/env-vars) for the full variable reference.
